...
import numpy as np
import ook_3_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class ook_3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "OOK - versão 3", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("OOK - versão 3")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ook_3")
        ...
        self.tabs.addTab(self.tabs_widget_1, 'Canal')
        ...
        self.qtgui_time_sink_x_0_0.set_y_axis(-2.0, 2.0)
        ...
        self.tabs_grid_layout_2.addWidget(self._qtgui_time_sink_x_0_0_win, 0, 0, 1, 1)
        for r in range(0, 1):
        ...
        self.qtgui_time_sink_x_0.set_trigger_mode(qtgui.TRIG_MODE_TAG, qtgui.TRIG_SLOPE_POS, 0.0, 0, 0, "quadro")
        ...
        self.tabs_grid_layout_2.addWidget(self._qtgui_sink_x_1_win, 1, 0, 1, 2)
        for r in range(1, 2):
            self.tabs_grid_layout_2.setRowStretch(r, 1)
        for c in range(0, 2):
            self.tabs_grid_layout_2.setColumnStretch(c, 1)
        ...
        self.tabs_grid_layout_1.addWidget(self._qtgui_sink_x_0_0_win, 1, 1, 1, 1)
        for r in range(1, 2):
        ...
        self.tabs_grid_layout_0.addWidget(self._qtgui_sink_x_0_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.tabs_grid_layout_0.setRowStretch(r, 1)
        for c in range(0, 1):
            self.tabs_grid_layout_0.setColumnStretch(c, 1)
        ...
        self.qtgui_eye_sink_x_0.set_y_axis(-3.0, 3.0)
        ...
        self.tabs_grid_layout_2.addWidget(self._qtgui_eye_sink_x_0_win, 0, 1, 1, 1)
        for r in range(0, 1):
            self.tabs_grid_layout_2.setRowStretch(r, 1)
        for c in range(1, 2):
            self.tabs_grid_layout_2.setColumnStretch(c, 1)
        ...
        self.epy_block_0 = epy_block_0.blk(access_code=access_code, payload_len_in_bits=payload_len * 8)
        ...
        self.digital_diff_decoder_bb_0 = digital.diff_decoder_bb(8, digital.DIFF_DIFFERENTIAL)
        ...
        self.blocks_stream_to_tagged_stream_0 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, (N+sync_len), "quadro")
        ...
        self.connect((self.blocks_unpack_k_bits_bb_1, 0), (self.epy_block_0, 0))
        ...
        self.connect((self.fec_extended_tagged_decoder_0, 0), (self.digital_diff_decoder_bb_0, 0))
        ...
        self.connect((self.interp_fir_filter_xxx_1, 0), (self.qtgui_eye_sink_x_0, 0))
        self.connect((self.interp_fir_filter_xxx_1, 0), (self.qtgui_time_sink_x_0_0, 0))
    ...
    def set_baud_rate(self, baud_rate):
        ...
        self.set_rrc_filter_taps(firdes.root_raised_cosine(self.sps, self.samp_rate, self.baud_rate, 0.25, (11*self.sps)))
        self.set_samp_rate(self.baud_rate * self.sps)
        self.qtgui_sink_x_1.set_frequency_range(0, self.baud_rate)
    ...
    def set_N(self, N):
        ...
        self.blocks_stream_to_tagged_stream_0.set_packet_len((self.N+self.sync_len))
        self.blocks_stream_to_tagged_stream_0.set_packet_len_pmt((self.N+self.sync_len))
    ...
    def set_payload_len(self, payload_len):
        ...
        self.epy_block_0.payload_len_in_bits = self.payload_len * 8
...
def main(top_block_cls=ook_3, options=None):
